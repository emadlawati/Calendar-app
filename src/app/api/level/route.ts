...
export async function GET() {
  try {
    const [totalEvents, totalMemories, completedBucketItems, totalNotes] = await Promise.all([
    ...
    const score = computeScore(totalEvents, totalMemories, completedBucketItems, totalNotes);
