  ...
  const load = () =>
    fetch("/api/tasks", { credentials: "same-origin" })
      ...
      .then((d) => {
        ...
        // The badge, the drawer count and the standing notification all follow
        // every change here, so ticking something off updates the icon before
        // you have put the phone down.
        ledgerChanged();
      })
