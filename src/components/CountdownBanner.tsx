  ...
  return (
    ...
    >
      ...
      <div className="flex gap-2 sm:gap-3 relative z-10 shrink-0">
        <Link
          href="/notes"
          className="w-[52px] sm:w-16 flex flex-col items-center gap-1 sm:gap-1.5 py-2 sm:py-2.5 px-1.5 sm:px-2 rounded-xl sm:rounded-[14px] border transition-all hover:opacity-80"
          style={{
