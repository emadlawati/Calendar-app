...
import { ChevronLeftIcon, ChevronRightIcon, PencilIcon, TrashIcon, CategoryIcons } from "@/components/icons";
    ...
    <>
      ...
      >
        ...
        {photos.length > 0 ? (
          ...
          <div className="w-full h-28 flex items-center justify-center" style={{ background: cat.color, color: cat.textColor }}>
        ...
        <div className="p-6">
          ...
          <h2 className="heading-font text-xl mb-3" style={{ color: "var(--accent)" }}>
            {memory.event.title}
          </h2>
